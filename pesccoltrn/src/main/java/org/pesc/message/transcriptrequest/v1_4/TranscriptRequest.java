...
import org.pesc.sector.academicrecord.v1_9.RequestType;
 ...
 *         &lt;element name="Request" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}RequestType" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "TranscriptRequest")
