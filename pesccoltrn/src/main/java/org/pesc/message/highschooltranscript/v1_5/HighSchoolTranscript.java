...
import org.pesc.sector.academicrecord.v1_9.K12StudentType;
 ...
 *         &lt;element name="Student" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}K12StudentType"/>
...
@XmlRootElement(name = "HighSchoolTranscript")
public class HighSchoolTranscript {
    ...
    protected K12StudentType student;
     ...
     *     
     */
    public K12StudentType getStudent() {
        return student;
    }
     ...
     *     
     */
    public void setStudent(K12StudentType value) {
        this.student = value;
    }
