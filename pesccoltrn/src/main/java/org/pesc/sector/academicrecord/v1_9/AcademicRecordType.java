...
import org.pesc.core.coremain.v1_14.AdditionalStudentAchievementsType;
 ...
 *       &lt;sequence>
 *         &lt;element name="School" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}SchoolType" minOccurs="0"/>
 *         &lt;element name="StudentLevel" type="{urn:org:pesc:core:CoreMain:v1.14.0}StudentLevelType" minOccurs="0"/>
 *         &lt;element name="CohortGraduationYear" type="{urn:org:pesc:core:CoreMain:v1.14.0}CohortYearType" minOccurs="0"/>
 *         &lt;element name="AcademicAward" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}AcademicAwardType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AcademicSummary" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}AcademicSummaryFType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AcademicSession" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}AcademicSessionType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Course" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}CourseType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AdditionalStudentAchievements" type="{urn:org:pesc:core:CoreMain:v1.14.0}AdditionalStudentAchievementsType" maxOccurs="unbounded" minOccurs="0"/>
