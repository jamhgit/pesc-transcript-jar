 ...
 *       &lt;sequence>
 *         &lt;element name="SchoolCharacteristics" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}SchoolCharacteristicsType" minOccurs="0"/>
 *         &lt;element name="SchoolSupportServices" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}SchoolSupportServicesType" minOccurs="0"/>
 *         &lt;element name="FinancialAidNeeds" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}FinancialAidNeedsType" minOccurs="0"/>
 *         &lt;element name="StudentActivityCode" type="{urn:org:pesc:core:CoreMain:v1.14.0}StudentActivityCodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="OtherSelectionCharacteristics" type="{urn:org:pesc:sector:AcademicRecord:v1.9.0}CharacteristicsSelectionsType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
