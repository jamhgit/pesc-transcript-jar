 ...
 *         &lt;element name="OtherStudentAchievement" type="{urn:org:pesc:sector:AdmissionsRecord:v1.3.0}OtherStudentAchievementType" maxOccurs="unbounded" minOccurs="0"/>
...
public class AdditionalStudentAchievementsType {
    ...
    @XmlElement(name = "OtherStudentAchievement")
    protected List<OtherStudentAchievementType> otherStudentAchievement;
    ...
    /**
     * Gets the value of the otherStudentAchievement property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the otherStudentAchievement property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOtherStudentAchievement().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link OtherStudentAchievementType }
     * 
     * 
     */
    public List<OtherStudentAchievementType> getOtherStudentAchievement() {
        if (otherStudentAchievement == null) {
            otherStudentAchievement = new ArrayList<OtherStudentAchievementType>();
        }
        return this.otherStudentAchievement;
    }
